...
// Windows temporarily needs this file, https://github.com/module-federation/vite/issues/68
    ...
    const importMap = {
      ...
      ,
        "react-dom": async () => {
          let pkg = await import("__mf__virtual/remote_mf_2_app_mf_2_1__prebuild__react_mf_2_dom__prebuild__.js");
            return pkg;
        }
      ,
        "react-redux": async () => {
          let pkg = await import("__mf__virtual/remote_mf_2_app_mf_2_1__prebuild__react_mf_2_redux__prebuild__.js");
            return pkg;
        }
